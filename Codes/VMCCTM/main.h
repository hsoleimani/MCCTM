...
mcctm_model* new_mcctm_model(int ntopics, int nclasses, int nterms, double lambda, double nu);
mcctm_var * new_mcctm_var(mcctm_model* model, int nmax);

void train(char* dataset, char* lblfile, int nclasses, int ntopics, double lambda, double nu,
...
double doc_estep(document* doc, mcctm_model* model,
		mcctm_ss* ss, mcctm_var* var, int d, mcctm_epsopt* etaopt, int test, int comp_wrdlkh, double* phi);
