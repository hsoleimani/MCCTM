...
#pylab.ylim([-9.6, -8.3])
pylab.yticks([-3.35,-3.25,-3.15,-3.05])
pylab.ylabel('log-likelihood')
ax5.get_xaxis().set_ticklabels([])
ax6 = plt.subplot(gs2[-1, -1])
pylab.errorbar(prop,dmr[ind,5],yerr=dmr[ind,6],fmt='-o',color = 'g')
pylab.yticks([-16,-12,-8,-4])
pylab.text(1.19, 1.02, r'$10^6$', horizontalalignment='center', verticalalignment='center', transform=ax.transAxes)
#ax.set_xscale('log')
pylab.ylabel('log-likelihood')
pylab.xlabel('Label proportion')
pylab.show()
